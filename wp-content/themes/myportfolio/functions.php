...
if ( ! function_exists( 'myportfolio_setup' ) ) :
	...
	function myportfolio_setup() {
		...
		register_nav_menus( array(
			'main_menu' => esc_html__( 'Primary', 'myportfolio' ),
		) );
...
function myportfolio_scripts() {
	...
	wp_enqueue_script( 'myportfolio-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'myportfolio-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
